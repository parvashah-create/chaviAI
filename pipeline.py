...
# from snowpark import create_session
...
pinecone_utils = PineconeUtils(config("886881e8-cecd-45bb-ba0f-7d41cca305d2"),config("us-west4-gcp"))
...
def pipeline():
    ...
    if latest_tweets and vectors:
        ...
        # create_session()
        # create_session.write(latest_tweets_df,"shein_tweets")
